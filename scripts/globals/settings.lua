...
START_GIL = 70000; --Amount of gil given to newly created characters.
...
SAN_FAME   = 3.000; --Multiplies fame earned from San d'Oria quests.
BAS_FAME   = 3.000; --Multiplies fame earned from Bastok quests.
WIN_FAME   = 3.000; --Multiplies fame earned from Windurst quests.
NORG_FAME  = 3.000; --Multiplies fame earned from Norg and Tenshodo quests.
JEUNO_FAME = 3.000; --Multiplies fame earned from Jeuno quests.
...
FREE_RUNIC_PORTAL_USE = false; -- Defines whether to allow free use of runic portals to all staging points.
